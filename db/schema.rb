...
ActiveRecord::Schema[8.0].define(version: 2025_12_12_081835) do
  ...
  create_table "ownerships", force: :cascade do |t|
    ...
    t.index ["user_id", "car_id"], name: "index_ownerships_on_user_id_and_car_id", unique: true
  ...
  create_table "restaurants", force: :cascade do |t|
    ...
    t.index ["name", "city_id"], name: "index_restaurants_on_name_and_city_id", unique: true
